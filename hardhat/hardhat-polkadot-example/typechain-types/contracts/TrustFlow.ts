...
export interface TrustFlowInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface TrustFlow extends BaseContract {
  connect(runner?: ContractRunner | null): TrustFlow;
  waitForDeployment(): Promise<this>;

  interface: TrustFlowInterface;
