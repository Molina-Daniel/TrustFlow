...
export interface GovTokenInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "fundingManager",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "mintGovernanceTokens",
    values: [AddressLike, BigNumberish]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setFundingManager",
    values: [AddressLike]
  ): string;
...
export interface GovToken extends BaseContract {
  ...
  fundingManager: TypedContractMethod<[], [string], "view">;
  ...
  mintGovernanceTokens: TypedContractMethod<
  ...
  setFundingManager: TypedContractMethod<
    [_fundingManager: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "fundingManager"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "mintGovernanceTokens"
  ): TypedContractMethod<
    [to: AddressLike, amount: BigNumberish],
    [void],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "setFundingManager"
  ): TypedContractMethod<[_fundingManager: AddressLike], [void], "nonpayable">;
  getFunction(
